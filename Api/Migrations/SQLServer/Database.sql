...
GO
INSERT [dbo].[Customer] ([CustomerID], [Name], [Email], [Status], [StatusExpirationDate], [MoneySpent]) VALUES (2, N'Michal Samson', N'm.samson@yahoo.com', 2, CAST(N'2018-10-14T01:37:27.000' AS DateTime), CAST(9.00 AS Decimal(18, 2)))
GO
...
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (1, 1, 2, CAST(5.00 AS Decimal(18, 2)), CAST(N'2017-09-16T16:30:05.773' AS DateTime), CAST(N'2017-09-18T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (2, 2, 2, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-09-15T15:30:05.773' AS DateTime), NULL)
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (3, 1, 5, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-10-07T23:54:22.000' AS DateTime), CAST(N'2017-10-09T23:54:22.000' AS DateTime))
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (6, 1, 1, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-10-15T13:26:19.000' AS DateTime), CAST(N'2017-10-17T13:26:19.000' AS DateTime))
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (7, 1, 1, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-10-22T16:06:51.000' AS DateTime), CAST(N'2017-10-24T16:06:51.000' AS DateTime))
GO
